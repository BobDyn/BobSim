...
class SuspensionData:
    ...
    def __init__(self, path: str):
        ...
        self.g = raw_params["Environment"]["Gravity"]["Value"]
        ...
        self.Fr_unsprung_mass = raw_params["Mass Properties"]["Fr Unsprung"]["Value"]
        self.Rr_unsprung_mass = raw_params["Mass Properties"]["Rr Unsprung"]["Value"]

        self.total_mass = self.sprung_mass + self.Fr_unsprung_mass + self.Rr_unsprung_mass
        
        self.inertia_tensor = raw_params["Mass Properties"]["Sprung Inertia"]["Value"]
        ...
        if "FL QuarterCar" in raw_params.keys():
            ...
            if "push_pull_rod" in raw_params["FL QuarterCar"].keys():
                ...
                static_weight = self.total_mass * raw_params["Mass Properties"]["CGBX"]["Value"] * raw_params["Mass Properties"]["CGBY"]["Value"] * self.g
            ...
            static_weight = self.total_mass * raw_params["Mass Properties"]["CGBX"]["Value"] * (1 - raw_params["Mass Properties"]["CGBY"]["Value"]) * self.g
        ...
        if "RL QuarterCar" in raw_params.keys():
            ...
            if "push_pull_rod" in raw_params["RL QuarterCar"].keys():
                ...
                static_weight = self.total_mass * (1 - raw_params["Mass Properties"]["CGBX"]["Value"]) * raw_params["Mass Properties"]["CGBY"]["Value"] * self.g
            ...
            static_weight = self.total_mass * (1 - raw_params["Mass Properties"]["CGBX"]["Value"]) * (1 - raw_params["Mass Properties"]["CGBY"]["Value"]) * self.g
