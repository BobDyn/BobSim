...
void BobLib_Experiments_Standards_VehicleSim_function_initSynchronous(DATA *data, threadData_t *threadData)
{
...
/* Update base-clock. */
void BobLib_Experiments_Standards_VehicleSim_function_updateSynchronous(DATA *data, threadData_t *threadData, long base_idx)
{
...
int BobLib_Experiments_Standards_VehicleSim_function_equationsSynchronous(DATA *data, threadData_t *threadData, long base_idx, long sub_idx)
{
  int ret;
...
/* %v% = pre(%v%)*/
void BobLib_Experiments_Standards_VehicleSim_function_savePreSynchronous(DATA *data, threadData_t *threadData)
{
}
