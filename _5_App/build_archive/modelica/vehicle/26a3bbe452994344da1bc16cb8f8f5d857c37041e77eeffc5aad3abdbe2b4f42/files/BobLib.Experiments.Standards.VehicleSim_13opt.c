...
#include "BobLib.Experiments.Standards.VehicleSim_12jac.h"
#if defined(__cplusplus)
extern "C" {
#endif
int BobLib_Experiments_Standards_VehicleSim_mayer(DATA* data, modelica_real** res,short *i) {
...
int BobLib_Experiments_Standards_VehicleSim_lagrange(DATA* data, modelica_real** res, short * i1, short*i2) {
  throwStreamPrint(NULL, "The model was not compiled with -g=Optimica and the corresponding goal function. The optimization solver cannot be used.");
  return 0;
}
